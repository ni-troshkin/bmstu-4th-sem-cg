...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.line_color.setItemText(6, _translate("MainWindow", "Цвет фона"))
        ...
        self.spectre_alg.setItemText(1, _translate("MainWindow", "Библиотечный"))
        self.spectre_alg.setItemText(2, _translate("MainWindow", "ЦДА"))
        self.spectre_alg.setItemText(3, _translate("MainWindow", "Брезенхем"))
        self.spectre_alg.setItemText(4, _translate("MainWindow", "Брез. целочисленный"))
        self.spectre_alg.setItemText(5, _translate("MainWindow", "Брез. с устранением"))
        self.spectre_alg.setItemText(6, _translate("MainWindow", "Ву"))
